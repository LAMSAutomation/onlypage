...
import { ArrowRight, CalendarCheck, Check, Command, Globe2, IndianRupee, Languages, LayoutPanelTop, Menu, MessageCircle, MousePointer2, Sparkles, WandSparkles, X } from 'lucide-react';
      ...
      <section id="top" className="relative mx-auto max-w-7xl px-5 pb-16 pt-16 sm:px-8 sm:pb-24 sm:pt-24">
        ...
        <div className="relative grid items-center gap-12 lg:grid-cols-[1fr_0.9fr]">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 rounded-full border border-[#18201d]/10 bg-white px-3 py-1.5 text-xs font-bold text-[#53605a]"><span className="size-1.5 rounded-full bg-[#70a10d]" /> Built for businesses that run on WhatsApp</div>
            <h1 className="mt-6 max-w-3xl text-[clamp(3rem,7vw,6.4rem)] font-black leading-[0.92] tracking-[-0.075em] text-[#18201d]">Your website should help run your business.</h1>
            <p className="mt-7 max-w-xl text-lg leading-8 text-[#53605a]">Launch a page that can capture leads, take bookings, collect payment, and follow up—without learning a complicated design tool.</p>
            <div className="mt-8 flex flex-col gap-3 sm:flex-row"><button onClick={onStart} className="group inline-flex items-center justify-center gap-2 rounded-xl bg-[#18201d] px-5 py-3.5 text-sm font-black text-white transition hover:-translate-y-0.5 hover:bg-[#28332f]">Create my business page <ArrowRight size={16} className="transition group-hover:translate-x-0.5" /></button><button onClick={() => scrollTo('how-it-works')} className="inline-flex items-center justify-center gap-2 rounded-xl border border-[#18201d]/15 bg-white px-5 py-3.5 text-sm font-bold transition hover:border-[#18201d]/35">See how it works</button></div>
            <p className="mt-4 text-xs font-medium text-[#718078]">Start with Guided Launch. Studio Mode is ready when you need full control.</p>
          </div>
